...
TGraphAsymmErrors * plotTimeReturnTGraphAsymmErrorsRange2(TChain &pu200_gaus, TString numerator, TString denominator){
  ...
  TString z1("abs(vtxZ) < 0.5"), 
    z2("abs(vtxZ) < 3.0 && abs(vtxZ) > 0.5"), 
    z3("abs(vtxZ) < 7.75 && abs(vtxZ) > 3.0"), 

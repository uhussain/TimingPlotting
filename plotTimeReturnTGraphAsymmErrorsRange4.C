...
TGraphAsymmErrors * plotTimeReturnTGraphAsymmErrorsRange4(TChain &pu200_gaus, TString numerator, TString denominator){
  ...
  TString z1("abs(vtxZ) < 5.0 && abs(vtxZ) > 3.0"), 
    z2("abs(vtxZ) < 5.5 && abs(vtxZ) > 5.0"), 
    z3("abs(vtxZ) < 8.3 && abs(vtxZ) > 6.5"), 
    z4("abs(vtxZ) < 10.0 && abs(vtxZ) > 7.75"); //fix me should be 6.0 to 8.0
  ...
  for( unsigned i = 0; i < 3; ++i ) {
    ...
    dens_200[3] = 200*mygaus.Eval(zs_200[2]);
